...
while True:
    ...
    #else:
    #    print("Number of cars must be greater than 0 - please re-enter")
    Extra_Liability = input("Do you want extra liability coverage? (Y/N): ")
    Glass_Coverage = input("Do you want glass coverage? (Y/N): ")
    loaner_car = input("Do you want loaner car coverage? (Y/N): ")
    payment_method = input("How would you like to pay? (Full/Monthly/Down Pay): ")
